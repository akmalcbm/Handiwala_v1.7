package com.mauhandiwala.model;
...
public class ResultHome {
    ...
    @SerializedName("Flashsalelist")
    @Expose
    private List<Flashsalelist> flashsalelist = null;
    ...
    public void setFlashsalelist(List<Flashsalelist> flashsalelist) {
