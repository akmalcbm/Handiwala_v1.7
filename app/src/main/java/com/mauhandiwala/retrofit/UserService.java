package com.mauhandiwala.retrofit;
...
public interface UserService {
    ...
    Call<JsonObject> walletUpdate(@Body JsonObject object);

    @POST(APIClient.APPEND_URL + "getdata.php")
    Call<JsonObject> getDta(@Body JsonObject object);

    @POST(APIClient.APPEND_URL + "wallet_report.php")
    Call<JsonObject> getHistry(@Body JsonObject object);
}
